...
export const CircularTimer: React.FC<CircularTimerProps> = ({ 
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      {/* Center Content */}
      <div className="absolute flex flex-col items-center justify-center text-center max-w-[200px]">
        <div className="text-6xl md:text-7xl font-bold font-mono tracking-tighter text-slate-800 dark:text-white mb-4 transition-colors">
          {formatTime(timeLeft)}
        </div>
        <button
          onClick={onToggle}
